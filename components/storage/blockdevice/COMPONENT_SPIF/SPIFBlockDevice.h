...
public:
    ...
    /**
     * Added by TWTG
     * Sets the disabled mode. Default: AWAKE
     */
    enum class EDisabledMode_t {
        AWAKE,
        SLEEP
    };
    virtual void set_disabled_mode(EDisabledMode_t mode);
...
private:
    /**
     * Added by TWTG
     * Put the BlockDevice into deep power-down mode.
     * The command is common across many types of flash memory.
     * However, the wake-up procedure often varies between different flash models.
     */
    void sleep(void);
    void wake(void);
    ...
    // Added by TWTG
    bool            _is_enabled;
    EDisabledMode_t _disabled_mode;
};
