...
/**
 * @note
 * Calculation of INITIAL_SP for L451.
 *
 * SRAM1 start addr   : 0x2000 0000
 * SRAM1 + SRAM2 size : 0x0002 8000 <- 160k = 128k + 32k
 * SRAM2 end addr     : 0x2002 8000
 */
#elif (defined(TARGET_STM32L451RE))
